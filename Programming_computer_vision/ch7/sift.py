...
def process_image(imagename,resultname):
	...
	print(f'Finding ukbench/full/{imagename}...',end=' ',flush=True)
	im = cv.imread('ukbench/full/'+imagename,0)
	print('Done')
	...
	print(f'Writing to features/{resultname}...',end=' ',flush=True)
	features = []
	...
	np.savetxt('features/'+resultname,features)
...
def read_features_from_file(filename):
	...
	f = np.loadtxt('features/'+filename)
